...
class DatabaseProcessor:
    """Processes new data to list of objects:

    methods:
        add_new_employee_to_database(employee, list_of_objects): -> list_of_objects


    changelog: (When,Who,What)
        KODonnell,9.7.2020,Created Class
    """

    @staticmethod
    def add_new_employee_to_database(employee, list_of_objects):
        """ Reads data from a file into a list of object rows

        :param employee: (object) with name of new employee
        :param list_of_objects: (list) of employee objects
        :return: (list) of object rows
        """
